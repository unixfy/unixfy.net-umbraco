...
directives["configuredFormDesigner/designer.html"] = "<div>\n" +
   "    <umb-load-indicator ng-if=\"!initialized\"></umb-load-indicator>\n" +
   "    <form novalidate name=\"formulateConfiguredFormDesigner\"\n" +
   "          ng-submit=\"save()\"\n" +
   "          val-form-manager\n" +
   "          class=\"configured-form-designer\">\n" +
   "\n" +
   "        <umb-editor-view ng-if=\"initialized\">\n" +
   "            <umb-editor-header name=\"info.conFormName\"\n" +
   "                               hide-icon=\"true\"\n" +
   ...
   "                                        <option value=\"\" formulate-inject-localization=\"formulate-options_Select a Template\"></option>\n" +
   "                                    </select>\n" +
   "                                </div>\n" +
   "                            </div>\n" +
   "\n" +
...
directives["dataValueDesigner/designer.html"] = "<div>\n" +
   "    <umb-load-indicator ng-if=\"!initialized\"></umb-load-indicator>\n" +
   "    <form novalidate name=\"formulateDataValueDesigner\"\n" +
   "          ng-submit=\"save()\"\n" +
   "          val-form-manager>\n" +
   "\n" +
   "        <umb-editor-view ng-if=\"initialized\">\n" +
   "            <umb-editor-header name=\"info.dataValueName\"\n" +
   "                               alias=\"info.dataValueAlias\"\n" +
   "                               hide-icon=\"true\"\n" +
   "                               hide-description=\"true\"\n" +
   "                               hide-alias=\"false\">\n" +
   "            </umb-editor-header>\n" +
...
directives["dataValueKinds/dataValueList/dataValueList.html"] = "<fieldset>\n" +
   ...
   "        </localize>\n" +
   "    </legend>\n" +
   "    <div ui-sortable=\"sortableOptions\" ng-model=\"data.items\">\n" +
   "        <div ng-repeat=\"item in data.items\" class=\"formulate-data-value-item\">\n" +
   "            <i class=\"icon-navigation drag-handle\"></i>\n" +
   ...
   "        </div>\n" +
   "    </div>\n" +
   "    <button type=\"button\" class=\"btn btn-default formulate-add-data-value\" ng-click=\"addItem()\">\n" +
...
directives["dialogs/configuredFormPicker/formPicker.html"] = "<form name=\"configuredFormPickerForm\" novalidate val-form-manager>\n" +
   "    <umb-editor-view data-element=\"editor-configured-form-picker\">\n" +
   "        <umb-editor-header name=\"title\"\n" +
   "                           name-locked=\"true\"\n" +
   "                           hide-alias=\"true\"\n" +
   "                           hide-icon=\"true\"\n" +
   "                           hide-description=\"true\">\n" +
   ...
   "                                     root-id=\"rootId\"\n" +
   "                                     selection=\"selection\"\n" +
   "                                     previously-selected-ids=\"previouslySelectedIds\"\n" +
...
directives["dialogs/dataValuePicker/dataValuePicker.html"] = "<form name=\"dataValuePickerForm\" novalidate val-form-manager>\n" +
   "    <umb-editor-view data-element=\"editor-data-value-picker\">\n" +
   "        <umb-editor-header name=\"title\"\n" +
   "                           name-locked=\"true\"\n" +
   "                           hide-alias=\"true\"\n" +
   "                           hide-icon=\"true\"\n" +
...
directives["dialogs/formPicker/formPicker.html"] = "<form name=\"formPickerForm\" novalidate val-form-manager>\n" +
   "    <umb-editor-view data-element=\"editor-form-picker\">\n" +
   "        <umb-editor-header name=\"title\"\n" +
   "                           name-locked=\"true\"\n" +
   "                           hide-alias=\"true\"\n" +
   "                           hide-icon=\"true\"\n" +
...
directives["dialogs/layoutPicker/layoutPicker.html"] = "<form name=\"layoutPickerForm\" novalidate val-form-manager>\n" +
   "    <umb-editor-view data-element=\"editor-layout-picker\">\n" +
   "        <umb-editor-header name=\"title\"\n" +
   "                           name-locked=\"true\"\n" +
   "                           hide-alias=\"true\"\n" +
   "                           hide-icon=\"true\"\n" +
...
directives["dialogs/validationPicker/validationPicker.html"] = "<form name=\"validationPickerForm\" novalidate val-form-manager>\n" +
   "    <umb-editor-view data-element=\"editor-validation-picker\">\n" +
   "        <umb-editor-header name=\"title\"\n" +
   "                           name-locked=\"true\"\n" +
   "                           hide-alias=\"true\"\n" +
   "                           hide-icon=\"true\"\n" +
   ...
   "            <umb-box>\n" +
   "                <umb-box-content>\n" +
   "                    <formulate-entity-picker include-root=\"false\"\n" +
   "                                             entity-kinds=\"entityKinds\"\n" +
   "                                             root-id=\"rootId\"\n" +
   "                                             previously-selected-ids=\"previouslySelectedIds\"\n" +
   "                                             selection=\"selection\">\n" +
...
directives["folderDesigner/designer.html"] = "<div>\n" +
   "    <umb-load-indicator ng-if=\"!initialized\"></umb-load-indicator>\n" +
   ...
   "\n" +
   "        <umb-editor-view ng-if=\"initialized\">\n" +
   "            <umb-editor-header name=\"info.folderName\"\n" +
   "                               hide-icon=\"true\"\n" +
   "                               hide-description=\"true\"\n" +
   "                               hide-alias=\"true\">\n" +
   "            </umb-editor-header>\n" +
...
directives["formDesigner/designer.html"] = "<div>\n" +
   "    <umb-load-indicator ng-if=\"!initialized\"></umb-load-indicator>\n" +
   "\n" +
   "    <form novalidate name=\"formulateFormDesigner\"\n" +
   "          ng-submit=\"save()\"\n" +
...
directives["handlers/emailHandler/emailHandler.html"] = "<div>\n" +
   ...
   "    <div class=\"umb-el-wrap\">\n" +
   "        <label class=\"control-label\">\n" +
   "            <localize key=\"formulate-labels_Delivery Type\">\n" +
   "                Delivery Type\n" +
   "            </localize>\n" +
   "            <small>\n" +
   "                <localize key=\"formulate-label-descriptions_Delivery Type\">\n" +
   "                    The type of delivery to each recipient (i.e., To, Cc, or Bcc). If unspecified,\n" +
   "                    Bcc will be assumed.\n" +
   "                </localize>\n" +
   "            </small>\n" +
   "        </label>\n" +
   "        <div class=\"controls controls-row\">\n" +
   "            <div>\n" +
   "                <select ng-options=\"deliveryType.id as deliveryType.name for deliveryType in deliveryTypes\" ng-model=\"configuration.deliveryType\">\n" +
   "                    <option value=\"\" formulate-inject-localization=\"formulate-options_Select a Delivery Type\"></option>\n" +
   "                </select>\n" +
   "            </div>\n" +
   "        </div>\n" +
   "    </div>\n" +
...
directives["layoutDesigner/designer.html"] = "<div>\n" +
   "    <umb-load-indicator ng-if=\"!initialized\"></umb-load-indicator>\n" +
   "\n" +
   "    <form novalidate name=\"layoutForm\"\n" +
   "          ng-submit=\"save()\"\n" +
   "          val-form-manager>\n" +
   "\n" +
   "        <umb-editor-view ng-if=\"initialized\">\n" +
   "            <umb-editor-header name=\"info.layoutName\"\n" +
   "                               alias=\"info.layoutAlias\"\n" +
   "                               hide-icon=\"true\"\n" +
   "                               hide-description=\"true\"\n" +
   "                               hide-alias=\"false\">\n" +
   "            </umb-editor-header>\n" +
   ...
   "            <umb-editor-container>\n" +
   "                <div class=\"form-horizontal\">\n" +
   "                    <formulate-layout-editor ng-if=\"directive\"\n" +
   "                                             directive=\"directive\"\n" +
   "                                             data=\"data\">\n" +
...
directives["removeEntityFromCloudConfirmation/removeEntityFromCloud.html"] = "<div ng-if=\"!initialized\">\n" +
   "    <localize key=\"formulate-general_Loading\">\n" +
   "        Loading...\n" +
   "    </localize>\n" +
   "</div>\n" +
   "<div ng-if=\"initialized\">\n" +
   "    <div class=\"formulate__dialog-confirmation-message\">\n" +
   "        Are you sure you want to <strong>remove</strong> this entity, \"{{entityName}}\", from Umbraco Cloud?\n" +
   "        <br>\n" +
   "        <br>\n" +
   "        <u>This will delete the file on this environment!</u>\n" +
   "        <br>\n" +
   "        <br>\n" +
   "        This will also remove it from the Git repository for this environment, after which you\n" +
   "        will be able to transfer this removal to another environment via the Umbraco\n" +
   "        Cloud UI.\n" +
   "    </div>\n" +
   "    <button type=\"button\" class=\"btn btn-link\" ng-click=\"cancel()\">\n" +
   "        <localize key=\"formulate-buttons_Cancel\">\n" +
...
directives["storeEntityToCloudConfirmation/storeEntityToCloud.html"] = "<div ng-if=\"!initialized\">\n" +
   "    <localize key=\"formulate-general_Loading\">\n" +
   "        Loading...\n" +
   "    </localize>\n" +
   "</div>\n" +
   "<div ng-if=\"initialized\">\n" +
   "    <div class=\"formulate__dialog-confirmation-message\">\n" +
   "        Are you sure you want to store this entity, \"{{entityName}}\", to Umbraco Cloud?\n" +
   "        <br>\n" +
   "        <br>\n" +
   "        This will add it to the Git repository for this environment, after which you\n" +
   "        will be able to transfer this entity to another environment via the Umbraco\n" +
   "        Cloud UI.\n" +
   "        <br>\n" +
   "        <br>\n" +
   "        If this entity already exists in Umbraco Cloud, the latest changes will be\n" +
   "        stored to Umbraco Cloud.\n" +
   "    </div>\n" +
   "    <button type=\"button\" class=\"btn btn-link\" ng-click=\"cancel()\">\n" +
   "        <localize key=\"formulate-buttons_Cancel\">\n" +
   "            Cancel\n" +
   "        </localize>\n" +
   "    </button>\n" +
   "    <button type=\"button\" class=\"btn btn-primary\" ng-click=\"storeEntity()\">\n" +
   "        Store to Umbraco Cloud\n" +
   "    </button>\n" +
   "</div>";

directives["validationDesigner/designer.html"] = "<div>\n" +
   "    <umb-load-indicator ng-if=\"!initialized\"></umb-load-indicator>\n" +
   "    <form novalidate name=\"formulateValidationDesigner\"\n" +
   "          ng-submit=\"save()\"\n" +
   "          val-form-manager>\n" +
   "        <umb-editor-view ng-if=\"initialized\">\n" +
   "            <umb-editor-header name=\"info.validationName\"\n" +
   "                               alias=\"info.validationAlias\"\n" +
   "                               hide-icon=\"true\"\n" +
   "                               hide-description=\"true\"\n" +
   "                               hide-alias=\"false\">\n" +
   "            </umb-editor-header>\n" +
   ...
   "                    <div class=\"umb-group-panel\">\n" +
   "                        <div class=\"umb-group-panel__content\">\n" +
   "                            <formulate-validation-editor ng-if=\"directive\"\n" +
   "                                                         directive=\"directive\"\n" +
   "                                                         data=\"data\">\n" +
...
directives["validationKinds/validationMandatory/validationMandatory.html"] = "<div class=\"control-group umb-control-group\">\n" +
   ...
   "    <div class=\"umb-el-wrap\">\n" +
   "        <label class=\"control-label\">\n" +
   "            <localize key=\"formulate-labels_Client Side Only\">\n" +
   "                Client Side Only?\n" +
   "            </localize>\n" +
   "            <small>\n" +
   "                <localize key=\"formulate-label-descriptions_Client Side Only\">\n" +
   "                    Should this validation only applied in the browser (and not on the web server)? This is uncommon,\n" +
   "                    but is useful for more advanced situations (e.g., when displaying only some of the fields in the\n" +
   "                    form).\n" +
   "                </localize>\n" +
   "            </small>\n" +
   "        </label>\n" +
   "        <div class=\"controls controls-row\">\n" +
   "            <input type=\"checkbox\" ng-model=\"data.clientSideOnly\" />\n" +
   "        </div>\n" +
   "    </div>\n" +
   "</div>";
...
controller.$inject = ["$scope", "$routeParams", "$route", "formulateTrees", "formulateConfiguredForms", "$location", "formulateTemplates", "editorService", "formulateLayouts"];
...
// Variables.
directive.$inject = ["formulateDirectives"];
controller.$inject = ["$scope", "$routeParams", "$route", "formulateTrees", "formulateDataValues"];
var app = angular.module("umbraco");
...
// Variables.
controller.$inject = ["$scope", "formulateVars", "localizationService"];
directive.$inject = ["formulateDirectives"];
var app = angular.module("umbraco");
...
// Variables.
directive.$inject = ["formulateDirectives"];
controller.$inject = ["$scope", "$routeParams", "$route", "formulateTrees", "formulateFolders"];
var app = angular.module("umbraco");
...
// Variables.
directive.$inject = ["formulateDirectives"];
controller.$inject = ["$scope", "$routeParams", "$route", "formulateTrees", "formulateForms", "$location", "editorService", "formulateValidations", "formulateLocalization", "formulateFields"];
var app = angular.module("umbraco");
...
// Variables.
directive.$inject = ["formulateDirectives"];
controller.$inject = ["$scope", "$routeParams", "$route", "formulateTrees", "formulateLayouts"];
var app = angular.module("umbraco");
...
// Variables.
controller.$inject = ["$scope", "formulateForms", "editorService", "notificationsService"];
directive.$inject = ["formulateDirectives"];
var app = angular.module("umbraco");
...
app.factory("formulateCloud", ["formulateVars", "formulateServer", function (formulateVars, formulateServer) {
